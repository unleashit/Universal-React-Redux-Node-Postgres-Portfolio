...
exports.socketio = function (http, sessionStore) {
    ...
    chat.on('connection', function (socket) {
        ...
        socket.on(
            'admin login',
            liveChatController.adminLogin.bind(this, socket, chat)
        );
        socket.on(
            'chatConnected',
            liveChatController.chatConnected.bind(this, socket, chat)
        );
        socket.on(
            'newUser',
            liveChatController.newUser.bind(this, socket, chat)
        );
        socket.on(
            'chatMessage',
            liveChatController.chatMessage.bind(this, socket, chat)
        );
        socket.on(
            'disconnect',
            liveChatController.disconnect.bind(this, socket, chat)
        );
        socket.on(
            'admin getUsers',
            liveChatController.adminGetUsers.bind(this, socket, chat)
        );
        socket.on(
            'admin remove',
            liveChatController.adminRemoveUser.bind(this, socket, chat)
        );
        socket.on(
            'admin delete',
            liveChatController.adminDeleteUser.bind(this, socket, chat)
        );
