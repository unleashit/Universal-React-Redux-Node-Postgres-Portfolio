...
router.redirect(
    '/graphic-design.html',
    'http://training.jasongallagher.org/portfolio/graphic-design',
    301
);
router.redirect(
...
router.redirect(
    ...
    'http://training.jasongallagher.org/services/lessons-and-training/drupal-training.html',
    301
);
router.redirect(
...
router.redirect(
    ...
    'http://training.jasongallagher.org/services/lessons-and-training/photoshop-training.html',
    301
);
router.redirect(
    '/services/lessons-and-training/indesign-training.html',
    'http://training.jasongallagher.org/services/lessons-and-training/indesign-training.html',
    301
);
router.redirect(
    '/services/lessons-and-training/illustrator-training.html',
    'http://training.jasongallagher.org/services/lessons-and-training/illustrator-training.html',
    301
);
