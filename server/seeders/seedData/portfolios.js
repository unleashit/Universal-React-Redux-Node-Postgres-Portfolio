module.exports = [
    ...
    },
    {
        ...
        description: 'Working full-time on a small team, I helped create a nationwide real estate directory and social network with comprehensive mapping, property/agent details, and user submitted reviews and information. My role was primarily building out the user interface in AngularJs.',
    ...
    },
    {
        ...
        description: 'Terra Global Capital is a financial services company in San Francisco I\'ve worked with for about 4 years. I created their main application in Drupal and over time have maintained and added features. Besides the site itself which serves as a news portal and media respository, it sells rebrandable subsites (via Drupal Multisite) to clients with a particular business model. On both the main site and client sites there is a multi-user publishing workflow with Workbench.',
        tags: 'Drupal, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql, AWS, Devops',
    ...
    },
    {
        ...
        description: 'Monticello is a searchable real estate and rental directory for the San Francsico Bay Area. It makes good use of Google Maps and has a CMS in Drupal for managing the listings and content. Responsive and mobile friendly design.',
        tags: 'Drupal, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'B2B and Retail Ecommerce store in Joomla and Virtuemart. Features include separate retail and wholesale catalogs and a searchable practitioner database.',
        tags: 'Ecommerce, Joomla, jQuery, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Created this design for a photography and digital imaging studio in Marin County. ',
    ...
    },
    {
        ...
        description: 'The Kitchen Sisters are Peabody Award winning independent producers of several ongoing radio programs on NPR. I worked with them for about five years maintaining their sites and blogs and providing training.',
    ...
    },
    {
        ...
        description: 'Ecommerce shop in Joomla that sells artistic fabrics. It is an original theme with a custom Paypal shopping cart.',
    tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Showcase and donation funraising site for non-profit organization that builds libraries and other buildings in Cambodia. Features an original responsive design, interactive timeline, custom jquery animations, Joomla with CCK for easy client updates.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Award Winning Dog Blog and social tip sharing site in Joomla.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Multilingual (English/French) site for the Association of French Schools in North America. Freatures an original responsive theme and is built in Drupal.',
        tags: 'Drupal, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql, Devops',
    ...
    },
    {
        ...
        description: 'St. Patrick\'s is a Catholic Seminary in Menlo park. I worked with them to design and develop a new site that served multiple purposes. Besides a marketing tool, the site was a made into a full scale communication tool for faculty, staff and students with various login levels and functionality.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Portfolio for a Landscape Architect in Joomla. The theme is an original design and features a custom component for the client to maintain the galleries.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Showcase site for a chain of west coast restaurants. Custom jquery animations, editable html menu (custom edit in place), gallery, and CCK for easy client updates that don\'t break the complex design.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        description: 'Showcase, blog and media database for the journal Conversations on Philanthropy.',
        tags: 'Joomla, jQuery, Javascript, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
    ...
    },
    {
        ...
        tags: 'Joomla, jQuery, Html, CSS, Design/UX, Frontend, Backend, PHP, MySql',
