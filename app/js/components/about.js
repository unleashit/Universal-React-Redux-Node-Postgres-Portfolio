            ...
            <section className="about container-fluid" id="about">
                ...
                <div className="row">
                    ...
                    <div className="col-sm-9 col-lg-6">
                        ...
                        <p>While my roots are in design and the user experience, I have made a major transition over the years to bring my focus towards development and computer science. For a while this translated to simply being a good at html, css and enough jquery to be dangerous. But once the Single Page App craze hit with so many interesting new possibitlies on the front end, I found that it was time to take a much deeper dive into engineering. </p>
