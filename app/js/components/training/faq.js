        ...
        <div className="faqs">
           ...
           <AccordionPane>
               ...
               <div className="faq-body">
                   <p>Each lecture is $60 /hr. with a two hour minimum per session.  Usually we'll meet twice a week for two hours, but once per week is fine if you are in less of a hurry or have a busy schedule.</p>
               </div>
           </AccordionPane>
            ...
            <AccordionPane>
                ...
                <div className="faq-body">
                    <p>Training is held online via web conferencing software. If you're thinking, "I'm traditional" and feel concerned about working remotely, I suggest at least giving it a try. With the screen sharing and code pairing software we'll use, I believe you'll quickly feel at home with it and in many ways find it more effective. If you'd really rather meet in person, I can sometimes make exceptions although the cost will include a travel fee and you'll need to have a home or office in the Berkeley/Oakland area.</p>
                </div>
            </AccordionPane>
            ...
            <AccordionPane>
                ...
                <div className="faq-body">
                    <p>Forget about road blocks. If you're having an issue between lessons, you are encouraged to shoot me an email or set up a brief online session if needed. Up to 30 minutes of office time per week is available for as long as we are working together.</p>
                </div>
            </AccordionPane>
            ...
            <AccordionPane>
                ...
                <p>If you tend to have a lot of schedule changes to the point that you think you'll have a difficult time keeping regular appointments, I would prefer that we hold off until you are able to maintain a predictable schedule.</p>
