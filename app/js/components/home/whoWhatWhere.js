            ...
            <section className="who-what-where container-fluid">
                <div className="row">
                    <div className="col-md-4">
                        ...
                        <img src={whoAmIicon} srcSet={`${whoAmIicon2x} 1.1x`} alt="Who I am" className="who-i-am" />
                    </div>
                    <div className="col-md-4">
                        <h3>What I do</h3>
                        ...
                        <img src={whatIdoIcon} srcSet={`${whatIdoIcon2x} 1.1x`} alt="What I do" className="what-i-do"/>
                    </div>
                    <div className="col-md-4">
                        ...
                        <img src={whereIamLocatedIcon} srcSet={`${whereIamLocatedIcon2x} 1.1x`} alt="Where I'm located" className="where-i-am" />
                    </div>
                </div>
            </section>
        );
